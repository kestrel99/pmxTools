#' Calculate C(t) for a 1-compartment linear model with first-order oral absorption after a single dose
#'
...
#'
#' @examples
#' Ctrough <- sd1CptLinearOral1O(t=0:24, CL=6, V=25, ka=1.1, Dose=600)
#'

sd1CptLinearOral1O <- function(t, CL, V, ka, Dose) {
